...
const s = StyleSheet.create({
  ...
  lifiIcon: { width: 56, height: 56, borderRadius: Radius.full, backgroundColor: "rgba(191,90,242,0.1)", justifyContent: "center", alignItems: "center", marginBottom: Spacing.md },
  ...
  chipActive: { backgroundColor: "rgba(191,90,242,0.15)", borderColor: Brand.lifi },
  ...
  solanaIcon: { width: 28, height: 28, borderRadius: Radius.full, backgroundColor: "rgba(153,69,255,0.12)", justifyContent: "center", alignItems: "center" },
  ...
  routeCard: { backgroundColor: Dark.bgCard, borderRadius: Radius.lg, padding: Spacing.xl, borderWidth: 1, borderColor: "rgba(191,90,242,0.25)", marginBottom: Spacing.lg },
