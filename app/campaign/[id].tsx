...
const s = StyleSheet.create({
  ...
  heroImg: { width: "100%", height: 120, borderRadius: Radius.lg, backgroundColor: "rgba(0,229,160,0.06)", justifyContent: "center", alignItems: "center", marginBottom: Spacing.lg },
  ...
  trustCard: { backgroundColor: "rgba(0,229,160,0.06)", borderRadius: Radius.lg, padding: Spacing.xl, borderWidth: 1, borderColor: "rgba(0,229,160,0.15)", alignItems: "center", marginBottom: Spacing.xl },
  ...
  secondaryBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: Spacing.sm, backgroundColor: "rgba(191,90,242,0.1)", paddingVertical: Spacing.lg, borderRadius: Radius.md, borderWidth: 1, borderColor: "rgba(191,90,242,0.25)" },
