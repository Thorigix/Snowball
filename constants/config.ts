...
export const ELEVENLABS_AGENT_ID = "agent_5901kr50rz2ef1zv27zs7291e3e0";

/** Gemini */
export const GEMINI_API_KEY = "AIzaSyAx2FrDRFriUIIgPJSB9nOxXqhuWQfaBNM";
export const FIREBASE_PROJECT_NUMBER = "947165604273";
